package com.officeworks.qa.base;
...
public class TestBase {
	...
	public TestBase()
	{
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("/Users/gvijaykumarreddy/Desktop/Selenium Practice/"
					+ "OfficeworksPOM/OfficeWorksTest/src/main/java/com/officeworks/qa/config/config.properties");
			prop.load(ip);
